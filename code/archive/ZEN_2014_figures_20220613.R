...
pc1z.pc2z
ggsave(pc1z.pc2z, filename = "figures/pc1z_pc2z.png",  width = 6.5, height = 6 ) #, bg = "transparent"
...
fc1.fc2
ggsave(fc1.fc2, filename = "figures/fc1_fc2.png",  width = 6.5, height = 6 ) #, bg = "transparent"
...
pce1.pce2
ggsave(pce1.pce2, filename = "figures/pce1_pce2.png",  width = 6.5, height = 6 ) 
...
pce2.pce3
ggsave(pce2.pce3, filename = "figures/pce2_pce3.png",  width = 6.5, height = 6 ) 
...
pc1z.fc1
ggsave(pc1z.fc1, filename = "figures/pc1z_fc1.png",  width = 6.5, height = 6 ) 
...
pc1z.fc2 = ggplot(ZEN_2014_site_means, aes(x = FC2, y = PC1.zos.site, group = Ocean, col = Ocean)) +
  ...
  geom_smooth(method = lm, fullrange = F, se = T, lwd = 1.0, na.rm=T)
pc1z.fc2
ggsave(pc1z.fc2, filename = "figures/pc1z_fc2.png",  width = 6.5, height = 6 ) 
...
shoots.canopy <- ggplot(ZEN_2014_site_means, aes(x = Zostera.shoots.core.site, y = Zostera.longest.leaf.length.site, group = Ocean, col = Ocean)) +
  ...
  geom_smooth(method = lm, fullrange = F, se = T, lwd = 1.0, na.rm=T) 
shoots.canopy
ggsave(shoots.canopy, filename = "figures/shoots_canopy.png",  width = 6.5, height = 6 )
...
shoots.zag <- ggplot(ZEN_2014_site_means, aes(x = log10.Zostera.shoots.core.site, y = log10.Zostera.AG.mass.site, group = Ocean, col = Ocean)) +
  ...
  geom_smooth(method = lm, fullrange = F, se = T, lwd = 1.0, na.rm=T) 
shoots.zag
ggsave(shoots.zag, filename = "figures/shoots_zag.png",  width = 6.5, height = 6 )
